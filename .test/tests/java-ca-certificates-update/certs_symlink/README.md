...
$ openssl req -nodes -new -x509 -days 358000 -subj "/DC=Temurin/CN=DockerBuilder3" -keyout certs/subfolder/dockerbuilder3.key -out certs/subfolder/.dockerbuilder3.crt
```
